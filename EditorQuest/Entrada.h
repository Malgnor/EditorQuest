...
enum { KB_CIMA, KB_DIREITA, KB_BAIXO, KB_ESQUERDA, KB_Z, KB_X, KB_C, KB_A, KB_S, KB_D, KB_W, KB_ESPACO, KB_ENTER, KB_CONTROL, KB_ESC,
	KB_ENCERRA, KB_0, KB_1, KB_2, KB_3, KB_4, KB_5, KB_6, KB_7, KB_8, KB_9, KB_M, KB_E, KB_I, KB_T, KB_O, KB_R, KB_Q, KB_U, KB_MAX_TECLAS };
